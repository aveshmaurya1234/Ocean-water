    ...
    <div className='flex justify-between text-white bg-zinc-800 px-2 py-5'>
        <div className=''>
          ...
          <div className='flex gap-3 my-3'>
              ...
              <div className=''>
                <p className='font-semibold text-lg leading-none '>Rahul Gupta (Partner)</p>
                <h1 className='font-extrabold text-xl leading-tight'>Everest Sanitation (India)</h1>
                <p className='font-semibold text-lg leading-tight'>B-55, Wazirpur Group Industrial Area</p>
                <p className='font-semibold text-lg leading-tight'>New Delhi - 110052, Delhi, India</p>
          ...
          <div className='flex items-center gap-3 my-3'>
              ...
              <h1 className='font-bold text-lg'>9453201921</h1>
          </div>
